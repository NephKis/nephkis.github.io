...
function tick() {
    ...
    var myYears, myMonths, myDays, myHours, myMinutes, mySeconds;
    var today;
    today = new Date(); //系统当前时间
    myYears = today.getFullYear(); //得到年份
    myMonths = today.getMonth() + 1; //得到月份，要加1
    myDays = today.getDate(); //得到日期
    myHours = today.getHours(); //得到小时
    myMinutes = today.getMinutes(); //得到分钟
    mySeconds = today.getSeconds(); //得到秒钟
    years = myYears + "-";
    if (myMonths < 10) {
        months = "0" + myMonths + "-";
    } else {
    ...
    //$("#myClock").html(new Date());
    $("#now_time").html(timeString);
...
// $(function(){
//     //吸顶灯小插件
//     $.fn.ceilling = function(options) {
//         var _THIS = this;
//         var _classname = options.classname;//定义定时器
//         var TIMER = null;//定义定时器
//         $(window).scroll( function() {
//             var m =$(document).scrollTop();
//             clearTimeout(_THIS.TIMER);//必须要有这句
//             if(m>0){
//                 _THIS.TIMER = setTimeout(function(){
//                     $(_THIS).addClass(_classname);
//                 },10);
//             }else{
//                 _THIS.TIMER = setTimeout(function(){
//                     $(_THIS).removeClass(_classname);
//                 },10);
//             }
//         });
//     };
